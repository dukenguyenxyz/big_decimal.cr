require "../src/big_decimal"
require "spec"

describe BigDecimal do
  describe "serialisation and deserialisation" do
  ...
  describe "to_s" do
    it "should .to_s for -1 < val < 0" do
      (-0.23).to_big_d.to_json.should eq("-0.23")
      ("-.23").to_big_d.to_json.should eq("-0.23")
    end

    it "should .to_s with offset of 1" do
      BigDecimal.new("1.0001").to_s.should eq "1.0001"
      BigDecimal.new("-.35").to_s.should eq "-0.35"
    end
  end

  describe "BigDecimal Stdlib Specs" do
